...
def add_iam_service_account_client(refresh_token, host, org_id, account_id):
    """
    ...
    create_service_account_client(host, access_token, org_id, account_id)
...
def create_service_account_client(host, access_token, org_id, account_id):
    """
    ...
    create_service_account_request = requests.post(service_account_url, **kwargs, stream=True)
    ...
    pprint.pprint(create_service_account_request.json())


if __name__ == '__main__':
    # click passes no args
    # pylint: disable=no-value-for-parameter
    add_iam_service_account_client(auto_envvar_prefix='FLEXERA')
