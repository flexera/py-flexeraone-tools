...
def delete_iam_service_account_client(refresh_token, host, org_id, account_id, client_id):
    """
    ...
    delete_service_account_client(host, access_token, org_id, account_id, client_id)
...
def delete_service_account_client(host, access_token, org_id, account_id, client_id):
    """
...
if __name__ == '__main__':
    ...
    delete_iam_service_account_client(auto_envvar_prefix='FLEXERA')
