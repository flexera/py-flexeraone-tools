...
def list_iam_service_account_clients(refresh_token, host, org_id, account_id):
    """
    ...
    list_service_account_clients(host, access_token, org_id, account_id)
...
def list_service_account_clients(host, access_token, org_id, account_id):
    """
    ...
    service_account_url = "https://{}/iam/v1/orgs/{}/service-accounts/{}/clients".format(host, org_id, account_id)
    list_service_account_clients_request = requests.get(service_account_url, **kwargs, stream=True)
    list_service_account_clients_request.raise_for_status()
    pprint.pprint(list_service_account_clients_request.json())


if __name__ == '__main__':
    # click passes no args
    # pylint: disable=no-value-for-parameter
    list_iam_service_account_clients(auto_envvar_prefix='FLEXERA')
