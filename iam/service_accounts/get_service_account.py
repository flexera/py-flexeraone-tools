...
def get_iam_service_accounts(refresh_token, host, org_id, account_id):
    """
    ...
    get_service_accounts(host, access_token, org_id, account_id)
...
def get_service_accounts(host, access_token, org_id, account_id):
    """
...
if __name__ == '__main__':
    ...
    get_iam_service_accounts(auto_envvar_prefix='FLEXERA')
